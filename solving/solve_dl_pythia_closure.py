...
def solve_event(lp, lm, MET_x, MET_y, pool, pool_labels):
    ...
    for i, j in permutations(range(4), 2):
        ...
        # Same-4-jet-pool logic as SL: getting (i, j) right automatically
        # leaves the correct {higgsb1, higgsb2} pair, so correct_pairing
        # already covers Higgs-pair correctness too -- no separate flag.
